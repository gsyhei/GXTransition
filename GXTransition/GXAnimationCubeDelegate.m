...
//    UIViewController *toVC = [transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
//
//    CGFloat width = fromVC.view.bounds.size.width;
...
//    [transitionContext.containerView addSubview:toVC.view];
//
//    transitionContext.containerView.layer.position = CGPointMake(width, height * 0.5);
//    transitionContext.containerView.layer.anchorPoint = CGPointMake(1.0, 0.5);
...
//        transitionContext.containerView.layer.position = CGPointMake(width * 0.5, height * 0.5);
//        transitionContext.containerView.layer.anchorPoint = CGPointMake(1.0, 0.5);
//    } completion:^(BOOL finished) {
//        fromVC.view.hidden = NO;
//        [fromSnapshotView removeFromSuperview];
...
//        transitionContext.containerView.layer.position = CGPointMake(width * 0.5, height * 0.5);
//        transitionContext.containerView.layer.anchorPoint = CGPointMake(0.5, 0.5);
//        toVC.view.layer.transform = CATransform3DIdentity;
